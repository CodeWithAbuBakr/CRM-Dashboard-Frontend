...
const Emails = () => {
  ...
  const initiateLogin = () => {
    ...
    const authUrl = `https://login.microsoftonline.com/common/oauth2/v2.0/authorize?client_id=9d3eccab-85a6-4c1d-b499-b30bac866ae1&response_type=code&redirect_uri=http://192.168.1.5:5173/auth.html&scope=user.read+mail.send+Mail.ReadBasic+Mail.Read+Mail.ReadWrite+offline_access&response_mode=fragment&state=12345&nonce=678910`;
